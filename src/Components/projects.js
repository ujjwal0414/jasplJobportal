...
const Project=()=>{
    return(
        <div className="md:w-[80%] w-[100%] h-[80vh] flex  justify-center">
            <div className="w-[95%] bg-slate-100  overflow-y-auto pb-3">
            <div className="grid md:grid-cols-3 gap-3 justify-evenly ml-5 mr-5 mt-5">
            <div className="bg-slate-300 min-h-[8vh] rounded-lg pb-2">
                            ...
                            <p className="ml-3 mr-2">We at JASPL are looking for skillful interns who will be collaborating with industry experts and will adorn their own skills.<br/>Below is the given google form to apply as your dream position.Good Luck!</p>
