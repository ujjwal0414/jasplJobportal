...
const Report = () => {
    ...
    let getUsers = async () => {
        try {
            response = await fetch("https://script.google.com/macros/s/AKfycbxaBnT6s4AmtJn4bm1Mw6DTc2WCVl-rvz7WTrnmZQ1OG3tzbZiz1YyvVHwe6q_zce4m/exec?action=getData");
                            ...
                            return (
                                <div key={pos} className="bg-slate-300 md:min-h-[45vh]  rounded-lg flex flex-col justify-between shadow-slate-500 hover:shadow-xl relative">
                                       ...
                                       {/*Only description part will be here and ends */}
                                        <div className="md:absolute bottom-0 w-[99%]">
                                        <p className="flex ml-3 w-[100%]">
